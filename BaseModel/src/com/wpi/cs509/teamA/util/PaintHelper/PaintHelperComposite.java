...
public class PaintHelperComposite extends PaintHelperBasics{
    ...
    public static void paintEverything(Graphics2D g2, BufferedImage image, LinearTransform pLinearTransform) {
        ...
        g2.drawImage(image, (int)pLinearTransform.getX(),
                (int)pLinearTransform.getY(),
                (int)Math.round(image.getWidth(imageComponent) * scale),
                (int)Math.round(image.getHeight(imageComponent) * scale),
                imageComponent);
    ...
    public static void paintNodes(java.util.List<Node> nodes, Graphics2D g2, PaintHelperBasics.DrawStyleEnum style, LinearTransform pLinearTransform) {
        PaintHelperBasics.setLinearTransform(pLinearTransform);
//		System.out.println("Drawing nodes.");
    ...
    public static void paintEdges(java.util.List<Edge> edges, Graphics2D g2, PaintHelperBasics.DrawStyleEnum style, LinearTransform pLinearTransform) {
        PaintHelperBasics.setLinearTransform(pLinearTransform);
        PaintHelperBasics.setStyle(style, g2);
        if (null == edges)
            return;
