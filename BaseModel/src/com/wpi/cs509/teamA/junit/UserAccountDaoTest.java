...
public class UserAccountDaoTest {
	...
	public static void main(String[] args) {
		...
		// if the username exists, return false, means cannot insert into the
		// database
		// if the username does not exist, return true, means can insert into
		// the database
		...
		/*
		 * NodeRelationDao nrd = new NodeRelationDaoImpl(); Node n1 = new
		 * Node(); n1.setId(100); Node n2 = new Node(); n2.setId(20);
