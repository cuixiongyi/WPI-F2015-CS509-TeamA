...
/**
 * 
 * This class is different from the class edge in the strategy package.
 * 
 * This class is for persistence to record the relationship of two node.
 * Logically, it is the edge.
 * 
 * 
 * @author Team-A
 *
...
public class NodeRelation {
	...
	/**
	 * @param firstNodeCoordinate
	 *            the firstNodeCoordinate to set
	 */
	...
	/**
	 * @param secondNodeCoordinate
	 *            the secondNodeCoordinate to set
	 */
